...
| P-4 장소 상세 전부 | GET /saved-places/{placeId}, GET /saved-places/{placeId}/media, DELETE /saved-places/{placeId} | 장소 정보 / 관련 sharedMedias [{sharedMediaId, thumbnailUrl, author, caption, sharedUrl, sharedAt}] | 상세만 신규 |
